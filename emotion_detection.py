...
face_detection = cv2.CascadeClassifier(r'models/haar_cascade_face_detection.xml')
labels = ['Surprise', 'Neutral', 'Anger', 'Happy', 'Sad']
model = tf.keras.models.load_model(r'models/network-5Labels.h5')

def face_detector_ep(image):
